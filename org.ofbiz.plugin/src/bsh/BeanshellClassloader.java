...
public class BeanshellClassloader extends URLClassLoader {
	 ...
	 */
	public BeanshellClassloader(URL[] urls) {
		this(urls, null);
	}
	 ...
	 */
	public BeanshellClassloader(ClassLoader parent) {
		this(new URL[] {}, parent);
	}
	 ...
	 */
	public BeanshellClassloader(URL[] urls, ClassLoader parent) {
		super(urls, parent);
	}
