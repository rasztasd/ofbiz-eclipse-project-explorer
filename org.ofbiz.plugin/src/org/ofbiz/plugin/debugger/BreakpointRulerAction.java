...
//    }
	...
	public static void addBreakpointMarker(IDocument document, final int lineNumber, ITextEditor textEditor) {
		try {
            if (lineNumber < 0)
                return;
            ...
            map.put(IBreakpoint.ID, "org.ofbiz.plugin.markerId");
...
//            	}
            ...
            IWorkspaceRunnable runnable = new IWorkspaceRunnable() {
                public void run(IProgressMonitor monitor) throws CoreException {
                    IMarker marker = resource.createMarker("org.ofbiz.plugin.breakpointMarker");
                    marker.setAttributes(map);
                    PDALineBreakpoint br = new PDALineBreakpoint(resource, lineNumber);
                    br.setMarker(marker);
                    br.setEnabled(true);
